...
if __name__=="__main__":
        ...
        for i,e in enumerate(list4):
            for n in xrange(4):
                ...
                displaced_CASTEP_supercell=normalize_CASTEP_supercell(
                    move_two_atoms(CASTEP_supercell,
                                   e[1],e[3],isign*H,
                                   e[0],e[2],jsign*H))
	...
	for i in sorted(glob.glob(cell_names)):
        ...
        phifull=thirdorder_core.reconstruct_ifcs(phipart,wedge,list4,CASTEP_cell,CASTEP_supercell)
        print "Writing the constants to FORCE_CONSTANTS_3RD"
        write_ifcs(phifull,CASTEP_cell,CASTEP_supercell,dmin,nequi,shifts,frange,"FORCE_CONSTANTS_3RD")
    print doneblock
